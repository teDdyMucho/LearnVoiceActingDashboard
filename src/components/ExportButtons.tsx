...
export const ExportButtons: React.FC<ExportButtonsProps> = ({ transactions, products, metrics }) => {
  return (
    <div className="flex flex-wrap gap-3">
      ...
      <button
        onClick={() => exportProductSummaryToCSV(products)}
      ...
      <button
        onClick={() => exportDashboardSummaryToCSV(metrics, products)}
